...
userRouter.post("/:id/alerts",authMiddleWare.Validate,AlertController.addAlertForUser);
...
userRouter.delete("/:id/interests/:interestId", authMiddleWare.Validate,UserController.deleteInterest);
userRouter.put("/:id/interests/:interestId", authMiddleWare.Validate,UserController.updateInterest);

// Connections Routes
userRouter.post("/:id/connections", authMiddleWare.Validate,UserController.addConnection);
userRouter.delete(
